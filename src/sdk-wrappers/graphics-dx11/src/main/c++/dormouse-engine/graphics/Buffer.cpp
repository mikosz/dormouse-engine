...
Buffer::Buffer(Device& device, const Configuration& configuration, essentials::ConstBufferView initialData) :
	Resource(createBufferResource(device, configuration, initialData))
{
}
